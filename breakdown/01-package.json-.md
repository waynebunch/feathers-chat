...
```
{
  ...
  "version": "0.0.0",
@@ Name and version are important.  If the version is different there may be different deps.
  "homepage": "",
  "main": "src/",
@@ `main` tells node where to find the main app.  In this app, if the installer does a 
...
@@ Also, an important part of this is the version numbers.  If there's a ^ in front of the version,
@@ say, ^2.6.0, it's been tested and works with every version of 2.6.  Next major version (2.7) could
@@ break your app. 
  },
  "devDependencies": {
    "jshint": "^2.9.4",
...
@@ correctly modify this app the way it is.
  }
}
```
